<?php
    ...
    if($errer_flag == FALSE){
        echo "<font color=red>入力に誤りがあります</font><br>";
        echo '<a href="javascript:history.back()">選び直してください</a><br>';
    }
...
//     echo "順番:".$player_turn;
    ...
    if($errer_flag == FALSE){
        echo "";
            ...
            //player1の入力
            echo "<font color=red>プレイヤー1の番です</font><br>";
            ...
            //player2の入力
            echo "<font color=blue>プレイヤー2の番です</font><br>";
...
//     echo "2:".$player2_count."<br>";
    ...
    if($player1_count == 33){
        echo "<font color=red size=5px><b>プレイヤー1の勝利！</b></font>";
        echo '<br><a href="clickgame.php">もう1回遊ぶ</a><br>';
    } else if ($player2_count == 0){
        echo "<font color=blue size=5px><b>プレイヤー2の勝利！</b></font>";
        echo '<br><a href="clickgame.php">もう1回遊ぶ</a><br>';
    }
    ...
    if($errer_flag == FALSE){
        echo "<br>";
    } else if($player1_count == 3){
        echo "<img src=\"img/player1_c2.jpg\" height=130px  width=130px ><br>";
    } else if ($player2_count == 3){
        echo "<img src=\"img/player2_c2.jpg\" height=130px  width=130px ><br>";
    } else {
    ...
    if($errer_flag == FALSE){
        echo "";
    } else if($player1_count == 13){
        echo "<img src=\"img/player1_t2.jpg\" height=130px  width=130px ><br>";
    } else if ($player2_count == 13){
        echo "<img src=\"img/player2_t2.jpg\" height=130px  width=130px ><br>";
    } else {
    ...
    if($errer_flag == FALSE){
        echo "";
    } else if($player1_count == 33){
        echo "<img src=\"img/player1_c3.jpg\" height=130px  width=130px ><br>";
    } else if ($player2_count == 33){
        echo "<img src=\"img/player2_c3.jpg\" height=130px  width=130px ><br>";
    } else {
        echo "<img src=\"img/road_c3.jpg\" height=130px  width=130px ><br>";
    }
